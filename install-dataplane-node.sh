...
CONTROL_URL="${OCTOPUSCORE_CONTROL_URL:-http://127.0.0.1:8088/v1}"
PUBLIC_GATEWAY="${OCTOPUSCORE_NODE_PUBLIC_GATEWAY:-octopus.dedyn.io:443}"
CONTROL_RELAY_GATEWAY="${OCTOPUSCORE_CONTROL_RELAY_GATEWAY:-https://octopus.dedyn.io/relay/control}"
NODE_ID="${OCTOPUSCORE_NODE_ID:-oci-exit-1}"
NODE_ROLES="${OCTOPUSCORE_NODE_ROLES:-exit,relay}"
NODE_INTERFACE="${OCTOPUSCORE_NODE_INTERFACE:-octopus0}"
TUN_ADDRESS="${OCTOPUSCORE_TUN_ADDRESS:-10.111.0.1/24}"
ROUTE_ADDRESS="${OCTOPUSCORE_NODE_ROUTE_ADDRESS:-10.111.0.1/32}"
CLIENT_POOL="${OCTOPUSCORE_CLIENT_POOL:-10.111.0.0/24}"
